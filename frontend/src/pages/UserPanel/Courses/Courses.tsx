...
export default function Courses() {
  const [courses, setCourses] = useState<Weather[]>([]);
  const [showCourseState, setShowCourseState] = useState("all");
  const [shownCourses, setShownCourses] = useState<Weather[]>([]);
  ...
  const filterCourses = (state: string) => {
    switch (state) {
      case "all": {
          ...
          <div className="row">
            <div className="col-12">
              {shownCourses.length !== 0 ? (
                ...
                <div className="alert alert-dsnger">
