...
export default function Landing(): JSX.Element {
  ...
  const navgaviagte = useNavigate();
  const searchValueHandler = () => {
    navgaviagte(`/search/${searchValue}`);
  };
  return (
    <section className="landing">
      <div className="container">
        <h1 className="landing__title">
          <Typewriter
            onInit={(Typewriter) => {
              Typewriter.typeString("ما به هر قیمتی دوره تولید نمی کنیم")
                .start()
                .pauseFor(2000)
                .deleteAll()
                .typeString("اکادمی اموزشی - برنامه نویسی -سبزلرن")
                .start()
                .pauseFor(2000);
            }}
            options={{
        ...
        <div className="landing-status">
          <div className="landing-status__item">
            ...
            <span className="landing-status__count">
              {<LandingCounter count={indexInfo?.usersCount} />}
            </span>
          ...
          <div className="landing-status__item">
            ...
            <span className="landing-status__count">
              {<LandingCounter count={indexInfo?.coursesCount} />}
            </span>
          ...
          <div className="landing-status__item">
            ...
            <span className="landing-status__count">
              {<LandingCounter count={indexInfo?.totalTime} />}
            </span>
            <span className="landing-status__text">
